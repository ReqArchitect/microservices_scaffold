...
class TestConfig(Config):
    SQLALCHEMY_DATABASE_URI = os.environ.get('TEST_DATABASE_URL', 'postgresql+psycopg2://postgres:password@localhost:5432/business_case_service_test')
    TESTING = True
    AUTH_SERVICE_URL = os.environ.get('AUTH_SERVICE_URL', 'http://localhost:5001')
    CIRCUIT_BREAKER_FAILURE_THRESHOLD = 3
...
SERVICE_NAME = os.environ.get('SERVICE_NAME', 'business_case_service')
