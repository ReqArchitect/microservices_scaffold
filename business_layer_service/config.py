...
SQLALCHEMY_DATABASE_URI = os.environ.get('BUSINESS_LAYER_SERVICE_DATABASE_URL')
...
class Config:
    ...
    SWAGGER = {
        'title': 'Business Layer Service API',
        'uiversion': 3
    }
    
    # Service identity and discovery
    SERVICE_NAME = os.environ.get('SERVICE_NAME', 'business_layer_service')
...
class TestConfig(Config):
    SQLALCHEMY_DATABASE_URI = os.environ.get(
        'TEST_DATABASE_URL',
        'postgresql://postgres:password@localhost/business_layer_service_test'
    )
